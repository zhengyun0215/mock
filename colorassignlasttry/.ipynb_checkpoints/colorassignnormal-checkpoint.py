...
np.save('/home/yunzheng/mock/color/data/zcdf_new/cdf_zform_normal.npy', cdf_zform)
...
pro = mp.Pool(processes=36)
res = pro.map(mul, range(26241654))
np.save('/home/yunzheng/mock/color/data/zcdf_new/color_mul_normal.npy', res)
pro.close()
pro.join()
st2 = time.time()
